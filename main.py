...
class tiktok:
    ...
    def update_title(self):
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(
            f"TikTok Username Checker | Available: {self.available} | Unavailable: {self.unavailable} | Checked: {(self.available + self.unavailable)} | Remaining: {remaining} | Created by @KLNNNNN on Github"
        )
    ...
    def main(self):
        os.system(clear)
        if clear == "cls":
            ctypes.windll.kernel32.SetConsoleTitleW("TikTok Username Checker | Created by @KLNNNNN on Github")
